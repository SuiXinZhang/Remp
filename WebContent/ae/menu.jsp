      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
            <dd class="${param.menu eq 'ae1' ? 'layui-this':''}"><a href="/remp/ae/ae01show.html">&ensp;&ensp;合同概况</a></dd>
            <dd class="${param.menu eq 'ae2' ? 'layui-this':''}"><a href="/remp/ae/ae02show.html">&ensp;&ensp;贷款概况</a></dd>
            <dd class="${param.menu eq 'ae4' ? 'layui-this':''}"><a href="/remp/ae/ae04show.html">&ensp;&ensp;产权概况</a></dd>
            <dd class="${param.menu eq 'ae5' ? 'layui-this':''}"><a href="/remp/ae/ae05show.html">&ensp;&ensp;面积补差概况</a></dd>
          </dl>
        </li>
