					...
					<c:forEach items="${rows }" var="ins" varStatus="vs">
						<tr>
							<td><input type="checkbox" onclick="onSelect(this.checked)"
								name="idlist" value="${ins.aaa601 }"></td>
							<td>${vs.count }</td>
							<td><a href="#" onclick="onEdit('${ins.aaa601 }')">${ins.aaa602 }</a>
							</td>
							<td>${ins.aaa603 }</td>
							<td>${ins.aaa604 }</td>
							<td>${ins.aaa605 }</td>
							<td><a href="#"
								onClick="onBuilding('${ins.aaa601}','${ins.aaa602}')">楼栋管理</a></td>
							<td><a href="#" onClick="onDel('${ins.aaa601}')">删除</a></td>
						</tr>
					</c:forEach>
		...
		<table border="1" align="center" width="95%">
			<tr>
				<td align="center"><input type="submit" value="查询" name="next">
					<input type="submit" value="添加" name="next" formaction="<%=path %>/aa/areaAdd.jsp"> 
					<input type="submit" value="删除" name="next" disabled="disabled" formaction="<%=path %>/aa/aa06Delete.html" id="del"> 
					<input type="submit" value="返回" name="next" formaction="<%=path %>/aa/aa02Query.html" formnovalidate="formnovalidate"></td>
			</tr>
		</table>
