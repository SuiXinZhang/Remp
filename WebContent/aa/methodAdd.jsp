...
<tr>
	<td>付款方式</td>
	<td>
	<e:text name="aaa902" required="true" autofocus="true" defval="${ins.aaa902 }"/>
	</td>
</tr>
<tr>
	<td>折扣</td>
	<td>
	<e:number name="aaa903" required="true" step="0.001" defval="${ins.aaa903 }"/>
	</td>
</tr>
...
<tr>
	<td>生效日期</td>
	<td>
	<e:date name="aaa904" required="true"  defval="${ins.aaa904 }"/>
	</td>
</tr>
...
<tr>
	<td>生效日期</td>
	<td>
	<e:date name="aaa905" required="true"  defval="${ins.aaa905 }"/>
	</td>
</tr>
...
<tr>
	<td>是否选择贷款</td>
	<td id="aaa906">
	<e:radio name="aaa906" value="是:是,否:否,不确定:不确定"  required="true" defval="${empty param.aaa906?'是':ins.aaa906}" onclick="isDisplay()"/>
	</td>
</tr>
...
<tr id="aaa907" style="visibility:visible" >
	<td>按揭银行</td>
	<td>
	<e:text name="aaa907"  defval="${ins.aaa907 }"/>
	</td>
</tr>
...
<tr  id="aaa908" style="visibility:visible" >
	<td>按揭精确度</td>
	<td>
	<e:text name="aaa908"  defval="${ins.aaa908 }"/>
	</td>
</tr>
 ...
 <tr  id="aaa909" style="visibility:visible"  >
    <td>公积金银行</td>
    <td>
 		<e:text name="aaa909" defval="${ins.aaa909 }"/>
    </td>
 </tr>
 ...
 <tr  id="aaa910" style="visibility:visible" >
    ...
    <td>
 		<e:text name="aaa910" defval="${ins.aaa910 }"/>
    </td>
 </tr>
  ...
  <tr>
    <td>备注</td>
    <td>
 		<e:textarea rows="5" cols="45" name="aaa911" defval="${ins.aaa911 }"/>
    </td>
 </tr>
