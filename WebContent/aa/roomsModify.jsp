...
<tr>
	<td>状态</td>
	<td>
	<e:select value="等待:01,签约:02,已租:03"  name="aaa805" defval="01"/>
	</td>
</tr>
   ...
   <tr>
     <td>租售类型</td>
     <td>
       <e:radio value="可租:可租,可售:可售,租售:租售" defval="租售" name="aaa806"  />
     </td>
   </tr>
...
<tr>
	<td>户型</td>
	<td>
	<e:text value="${ins.aaa502 }" name="aaa807"  />
	</td>
</tr>
...
<tr>
 ...
 <tr>
    <td>备注</td>
    <td>
 		<e:textarea rows="5" cols="45" name="aaa812" />
    </td>
 </tr>
...
<c:forEach items='<%= request.getParameterValues("idlist") %>' var="ins" varStatus="vs">
	<input type="checkbox" name="List" style="display:none" value="${ins }" checked="checked">
</c:forEach>
