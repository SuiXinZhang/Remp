...
<body>
	...
	<form action="<%=path%>/aa/aa06Add.html" method="post">
		...
		<table border="1" align="center" width="45%">
			...
			<tr>
				<td>名称</td>
				<td><e:text name="aaa602" required="true"
						defval="${ins.aaa602 }" /></td>
			</tr>


			<tr>
				<td>地址</td>
				<td><e:text name="aaa603" required="true"
						defval="${ins.aaa603 }" /></td>
			</tr>

			<tr>
				<td>面积</td>
				<td><e:number name="aaa604" required="true" step="1"
						defval="${ins.aaa604 }" /></td>
			</tr>


			<tr>
				<td>备注</td>
				<td><e:textarea rows="5" cols="45" name="aaa605"
						defval="${ins.aaa605 }" /></td>
			</tr>
