		...
		<div class="layui-body">
			<div class="layui-anim layui-anim-scale"
				...
				<fieldset class="layui-elem-field layui-filed-title"
					...
					<form lay-filter="form" class="layui-form" id="myform"
						method="post">

						<div align="center">
							<div class="layui-form-item" align="left"
								style="padding-left: 238px">
								<div class="layui-inline">
									<label class="layui-form-label"> <i
										class="layui-icon layui-icon-rate-half"
										style="font-size: 20px; color: black;"></i> 发送类型
									</label>
									<div class="layui-input-inline">
										<input type="radio" name="aac509" value="2" title="邮箱"
											checked=""> <input type="radio" name="aac509"
											value="1" title="电话">
									</div>
								</div>
							</div>
							<div class="layui-form-item">
								<div class="layui-inline">
									<label class="layui-form-label"> <i
										...
										style="font-size: 20px; color: black;"></i> 业&ensp;务&ensp;员
									</label>
									<div class="layui-input-inline">
										<input type="tel" name="aac507" value="${ins.aac507 }"
											required="true" autocomplete="off" class="layui-input">
									</div>
								</div>
								<div class="layui-inline">
									<label class="layui-form-label" style="width: 110px"> <i
										class="layui-icon layui-icon-auz"
										style="font-size: 20px; color: black;"></i> 业务员编号
									</label>
									<div class="layui-input-inline">
										<input type="tel" name="aac503" value="${ins.aac503 }"
											required="true" autocomplete="off" class="layui-input">
									</div>
								</div>
							</div>
							...
							<div class="layui-form-item">
								<div class="layui-inline">
									<label class="layui-form-label"> <i
										...
										style="font-size: 20px; color: black;"></i> 消息主题
									</label>
									<div class="layui-input-inline">
										<input type="tel" name="aac502" value="${ins.aac502 }"
											required="true" autocomplete="off" class="layui-input">
									</div>
								</div>
								<div class="layui-inline">
									<label class="layui-form-label" style="width: 110px"> <i
										...
										style="font-size: 20px; color: black;"></i> 计划发送时间
									</label>
									<div class="layui-input-inline">
										<input type="text" name="aac505" id="date" lay-verify="date"
							...
							<div class="layui-form-item">
								<div class="layui-inline">
									<label class="layui-form-label"> <i
										...
										style="font-size: 20px; color: black;"></i> 消息内容
									</label>
									<div class="layui-input-block">
										<textarea cols="71" placeholder="请输入内容" name="aac506"
											class="layui-textarea">${ins.aac506 }</textarea>
									</div>
								</div>
							</div>
						...
						<c:if test="${empty ins.aac501 }">
							...
							<div id="tableId" style="display: none">
								...
								<div class="layui-form-item">
									<div class="layui-inline">
										<label class="layui-form-label" style="padding-left:176px">客&ensp;户&ensp;名</label>
										<div class="layui-input-inline">
												...
												<c:forEach items="${rows }" var="ins" varStatus="vs">
													<tr>
														<td><input type="checkbox" lay-skin="primary"
															lay-filter="check" name="idlist" value="${ins.aac401 }"></td>
														<td>${vs.count }</td>
														<td>${ins.aac402 }</td>
														<td>${ins.aac403 }</td>
														<td>${ins.aac407 }</td>
